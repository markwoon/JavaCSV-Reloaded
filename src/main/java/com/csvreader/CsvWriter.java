...
public class CsvWriter implements AutoCloseable {
   ...
   * <p>
   * Note this method does not allow you to set the Windows
   ...
   * {@link #setRecordDelimiter(String)}.
   * <p>
   * This method was kept for compatibility with previous
   * versions.
   */
   ...
   * Sets the character to use as the record delimiter.
   *
   * @param recordDelimiter The {@code String} to use as the record delimiter. Default is
   * the operative system native line separator.
   * <p>
   * This method was added in version 2.2 and allows the
   * delimiter to be a {@code String}.
   */
  ...
  public void write(String content, boolean preserveSpaces)
    ...
    if (!textQualify
        ...
        || (useCustomRecordDelimiter && content.contains(userSettings.RecordDelimiter))
